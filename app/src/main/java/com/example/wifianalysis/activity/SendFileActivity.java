package com.example.wifianalysis.activity;
...
import com.example.wifianalysis.FileBean;
import com.example.wifianalysis.R;
import com.example.wifianalysis.utils.FileUtils;
import com.example.wifianalysis.utils.Md5Util;
...
public class SendFileActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mBtnChoseFile = findViewById(R.id.btn_chosefile);
        Button mBtnConnectServer = findViewById(R.id.btn_connectserver);

        mTvDevice = findViewById(R.id.lv_device);
    ...
    public void onDeviceInfo(WifiP2pDevice wifiP2pDevice) {
        deviceInfo.setText(wifiP2pDevice.deviceName+"\n"+wifiP2pDevice.deviceAddress);
    }
}
